...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('NgaDu.com - Solving our problem') }}</title>
          ...
          <div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <!-- <li class="button-container text-center">
                <button id="twitter" class="btn btn-round btn-twitter"><i class="fa fa-twitter"></i> &middot; 1000</button>
                <button id="facebook" class="btn btn-round btn-facebook"><i class="fa fa-facebook-f"></i> &middot; 1200</button>
                <br>
                <br>
              </li> -->
            </ul>
